                                ...
                                [
                                    ...
                                    dbc.CardBody(
                                        [
                                            ...
                                            html.Hr(),
                                            html.Div(
                                                c.msg_no_site, id='container-site-info'
                                            ),
                                        ]
                                    ),
                                ],
                    ...
                    dbc.Col(
                        [
                            dbc.Card(
                                [
                                    dbc.CardHeader(
                                        'Graph parameters', className='text-center'
                                    ),
                                    dbc.CardBody(
                                        [
                                            dbc.Select(
                                                ...
                                                options=[
                                                    {
                                                        'label': c.metric_names[
                                                            'temperature'
                                                        ],
                                                        'value': 'temperature',
                                                    },
                                                    {
                                                        'label': c.metric_names['ph'],
                                                        'value': 'ph',
                                                    },
                                                    {
                                                        'label': c.metric_names[
                                                    ...
                                                    },
                                                    {
                                                        ...
                                                        'value': 'dissolved_oxygen_percentage',
                                                    },
                                                    {
                                                        'label': c.metric_names[
                                                            'salinity'
                                            ...
                                            dbc.Tooltip(
                                                "Trend:  use Mann-Kendall (MK) test to detect upward or downward trends, "
                                                " and Theil–Sen estimator to robustly fit a line",
                        ...
                        [
                            dbc.Card(
                                [
                                    ...
                                    dbc.CardBody(
                                        c.msg_no_point, id='container-wtr-info'
                                    ),
